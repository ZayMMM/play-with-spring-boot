package com.next.springframework.spring5recipeapp.bootstrap;

import com.next.springframework.spring5recipeapp.model.*;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes(){
        ...
        guacRecipe.setDescription( Difficulty.EASY.toString() );
